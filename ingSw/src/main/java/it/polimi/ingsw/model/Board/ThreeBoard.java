...
public class ThreeBoard extends Board{
    ...
    public void setupBoard() {
        ...
        //read from json file
        String filePath = "ingSw/src/main/java/it/polimi/ingsw/model/Board/ThreeBoard.json";
        File input = new File(filePath);
        List<Tile> newBoard = new ArrayList<>();
        try {
            JsonElement fileElement = JsonParser.parseReader(new FileReader(input));
            JsonObject fileObject = fileElement.getAsJsonObject();
            JsonArray jsonArrayOfTiles = fileObject.get("threeBoard").getAsJsonArray();
            ...
            System.err.println("Errore di lettura del file ThreeBoard.json");
            e.printStackTrace();
        }
